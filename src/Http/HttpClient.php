...
class HttpClient
{
    ...
    public function get(string $endpoint, array $queryParams = []): array
    {
        try {
            ...
            if (json_last_error() !== JSON_ERROR_NONE) {
                throw new ApiException('Error decoding JSON response: ' . json_last_error_msg());
            }
            ...
            if ($response) {
                ...
                if (json_last_error() === JSON_ERROR_NONE) {
                    ...
                    throw new ApiException($message, $e->getCode(), $e, $errorCode, $data);
                }
            }
            
            throw new NetworkException('Network error: ' . $e->getMessage(), $e->getCode(), $e);
        }
    }
     ...
     * @throws ApiException|NetworkException If there is an API or network error
     */
    ...
    private function request(string $method, string $endpoint, array $options = []): array
    {
        try {
            ...
            if ($e->getCode() >= 400 && $e->getCode() < 500) {
                throw new ApiException('API error: ' . $e->getMessage(), $e->getCode(), $e);
            } else {
                throw new NetworkException('Network error: ' . $e->getMessage(), $e->getCode(), $e);
            }
        }
